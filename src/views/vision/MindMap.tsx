...
const MindMap = () => {
    ...
    const dataTransform = (data: any) => {
        const changeData = (d: any, level = 0, color: any) => {
            ...
            if (d.children) {
                data.children = d.children.map((child: any) =>
      ...
      `
        ...
        G6.registerBehavior('dice-mindmap', {
            ...
            clickNode(evt: {
                ...
                target: { get: (arg0: string) => any }
                currentTarget: {
                    updateItem: (arg0: any, arg1: { children: any }) => void
            ...
            editNode(evt: {
                item: any
                currentTarget: {
                    getClientByPoint: (arg0: any, arg1: any) => any
                    getZoom: () => any
                }
            }) {
                const item = evt.item
            ...
            hoverNode(evt: {
                currentTarget: { updateItem: (arg0: any, arg1: { hover: boolean }) => void }
                item: any
            }) {
                evt.currentTarget.updateItem(evt.item, {
                    hover: true,
    ...
    const init = () => {
        const container = mindRef.current as HTMLDivElement
        ...
        const tree = new G6.TreeGraph({
            container: mindRef.current as HTMLDivElement,
            width,
            height,
            fitView: true,
            ...
            layout: {
                ...
                getSide: (node: { data: { direction: any } }) => {
